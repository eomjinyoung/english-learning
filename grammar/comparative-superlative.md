# 비교급, 최상급(comparative, superlatve)
```
비교하는 말투를 만드는 문법
...
> '최상급/형용사'가 꾸며주는 명사가 예상 가능한 뻔한 명사인 경우 그 명사를 생략하기도 한다.
```
the + 최상급 + (명사 생략)
- `the richest` (people)
- `the strongest` (man)
...
```
가설1:
> 비교하는 말에서 공통 발음들이 나타나기 시작했고, 
  이 공통의 발음들이 일반 형용사에서 규칙적으로 적용되게 되었다. 
```
예:
...
> more, most는 형용사 뿐만 아니라 명사, 동사, 부사에도 붙이기 때문에
  ...
  반복을 피하고자 뒤의 -er, -est를 형용사에 붙여 사용하게 되었다.
```
more/most + 명사:
